...
<Tip>
  One Trend can have **multiple tokens** — each with its own LP, fee splits, holders, and UGC pool. The Creator and Community Treasury sit at the Trend level, shared across all tokens under it.
</Tip>
